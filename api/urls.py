...
from .views import getActivoListAPIView, getActivoUbicacionListAPIView, getActivoNombreListAPIView, getActivoCodigoListAPIView, getActivoDescripcionListAPIView
